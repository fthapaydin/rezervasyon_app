export const TURKEY_CITIES = [
  ...
  { name: 'Eskişehir', districts: ['Alpu', 'Beylikova', 'Çifteler', 'Günyüzü', 'Han', 'İnönü', 'Mahmudiye', 'Mihalgazi', 'Mihalıççık', 'Odunpazarı', 'Seyitgazi', 'Sivrihisar', 'Tepebaşı'] },
  ...
  { name: 'Kars', districts: ['Akyaka', 'Arpaçay', 'Digor', 'Kağızman', 'Merkez', 'Sarayköy', 'Sarıkamış', 'Selim', 'Susuz'] },
